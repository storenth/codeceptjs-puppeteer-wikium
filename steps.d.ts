...
type ICodeceptCallback = (i: CodeceptJS.I, mainPage:CodeceptJS.mainPage, changeLanguageStep:CodeceptJS.changeLanguageStep) => void;
...
declare namespace CodeceptJS {
  ...
  export interface changeLanguageStep {
